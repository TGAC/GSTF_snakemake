...
#python3 gstf_preparation.py --gff3 test:test.gff --fasta test.fa --header TranscriptId_species -o test --of test_1.fa --filter canonical
#gff3 <species-name>:<gff> 
#-o SQLite database will be needed for visualisation
#-of filtered fasta with one CDS per gene
#--filter canonical - for longest/protein coding CDS
#         coding - only protein coding
#	  empty - return all
#--regions - to discard CDS from certain region
